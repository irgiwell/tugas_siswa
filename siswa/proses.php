<?php
    ...
    if(isset($_POST['aksi'])){
        ...
        $sekolah = $_POST['sekolah_asal'];
        $tl_mysql = date("y-m-d" , strtotime ($tl));
        $sql ="UPDATE siswa SET nama='$nama',alamat='$alamat',jenis_kelamin='$jk',agama='$agama',sekolah_asal='$sekolah',
...
if(isset($_GET['hapus'])){
    ...
    $sql ="DELETE FROM siswa WHERE id_pendaftaran='$id_pendaftaran';";
    $query = mysqli_query($db, $sql);
